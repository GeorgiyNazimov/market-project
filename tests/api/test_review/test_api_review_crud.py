...
@pytest.mark.asyncio
async def test_cannot_create_review_for_unknown_product(db_session, async_client, app, override_get_session):
    new_product = product_factory()
    new_user = user_factory()
...
@pytest.mark.asyncio
async def test_cannot_create_review_by_unknown_user(db_session, async_client, app, override_get_session):
    new_product = product_factory()
