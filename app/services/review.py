...
from app.repositories.review import create_product_review_db, get_product_reviews_list_db
...
async def get_product_reviews_list(
    ...
    reviews_list, next_cursor = await get_product_reviews_list_db(product_id, created_at_cursor, id_cursor, limit, session)
