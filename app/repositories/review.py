    ...
    try:
        ...
        stmt = (
            ...
            .on_conflict_do_update(
                ...
                set_={
                    "rating_1_count": ProductAverageRating.rating_1_count
                    + int(rating == 1),
                    "rating_2_count": ProductAverageRating.rating_2_count
                    + int(rating == 2),
                    "rating_3_count": ProductAverageRating.rating_3_count
                    + int(rating == 3),
                    "rating_4_count": ProductAverageRating.rating_4_count
                    + int(rating == 4),
                    "rating_5_count": ProductAverageRating.rating_5_count
                    + int(rating == 5),
...
async def get_product_reviews_list_db(
    ...
    if results:
        last = results[-1]
        next_cursor = {"created_at": last.created_at, "id": str(last.id)}
